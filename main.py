...
if __name__ == '__main__':
    ...
    parser.add_argument("--logdir", default=".", type=str, help='Same as tensorboarg commands for --logdir. The program will search for events file recurrently under the given directory.')
    ...
    parser.add_argument("--use_relative_time", action="store_true", help="Use relative time reather than iters. Not functioning well.")
    ...
    if args.load_data:
        ...
        # Add keyword here more for DataFrame interpolate
        ...
        while True:
            ...
            print('\nFound events:')       
            for t_i, a_i in zip(groups, aliases): 
                print('\t%s: %s' % (t_i, a_i))
